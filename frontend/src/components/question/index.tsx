            ...
            <div className={styles.wrapper}>
                <div className={styles.front}>
                    <div className={styles.upper}>
                        ...
                        <p className={styles.label}>/explain</p>
                    </div>
                    <div className={styles.lower}>
                        <p className={styles.topic}>{props.question.topic}</p>
                    </div>  
                </div>
                <div className={styles.back}>
                    ...
                    <div className={styles.lower}>
                        <p className={`${styles.text} ${props.className ? props.className : ''}`}>{props.question.question}</p>
                    </div>
                </div>
            </div>
        </div>
